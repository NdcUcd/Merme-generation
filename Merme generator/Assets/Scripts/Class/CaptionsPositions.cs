...
public static class CaptionsPositions
{

    public static List<List<List<int>>> data = new List<List<List<int>>>
    {
        new List<List<int>>//0
        {
            new List<int> { 0, 75 },
        ...
        {
            new List<int> { 100, 110 },
            new List<int> { 100, -50 }
        },

        new List<List<int>>//18
        {
            new List<int> { 100, 140 },
